...
(function(global){
  ...
  const PAL = [OK.blue, OK.verm, OK.green, OK.yellow, OK.sky, OK.magenta, OK.orange, '#FF4F6B',
...
(function(g){
  ...
  function render18(container, skills, keys, opts){
    ...
    var PAL = ['#0072B2','#D55E00','#009E73','#F0E442','#56B4E9','#CC79A7','#E69F00','#FF4F6B','#332288','#88CCEE','#44AA99','#117733','#999933','#DDCC77','#CC6677','#882255','#661100','#888'];
