...
(function(){
  const TEAM_COLORS = {
    'ATL':['#E03A3E','#C1D32F'],'BOS':['#007A33','#BA9653'],'BKN':['#FFFEF7','#FFFFFF'],'CHA':['#1D1160','#00788C'],
    'CHI':['#CE1141','#FFFEF7'],'CLE':['#860038','#FDBB30'],'DAL':['#00538C','#002B5E'],'DEN':['#0E2240','#FEC524'],
    ...
    'POR':['#E03A3E','#FFFEF7'],'SAC':['#5A2D81','#63727A'],'SAS':['#C4CED4','#FFFEF7'],'TOR':['#CE1141','#FFFEF7'],
    'UTA':['#002B5C','#F9A01B'],'WAS':['#002B5C','#E31837'],
    // legacy / defunct mapped to current palette
    'VAN':['#5D76A9','#12173F'],'CHH':['#1D1160','#008CA8'],'SEA':['#00653A','#FFC62F'],'NJN':['#FFFEF7','#808080'],'CHO':['#1D1160','#00788C']
  };
