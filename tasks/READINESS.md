...
**Nothing here is live.** Everything below is measured at **`0d0cfb61`** — the sha is the anchor,
...
| | |
|---|---|
| commits ahead of master | 191 at `0d0cfb61` |
| paths changed | 2,637 (2,547 under `public/`, 37 scripts) |
| insertions / deletions | +206,793 / −310,495 |
| working notes | `tasks/frontend-live-buildout-2026-08-10.md`, 5,424 lines |
