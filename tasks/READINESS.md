...
**Nothing here is live.** Everything below is measured at **`af34e01d`** — the sha is the anchor,
...
| | |
|---|---|
| commits ahead of master | 195 at `af34e01d` |
| paths changed | 2,641 (2,547 under `public/`, 40 scripts) |
| insertions / deletions | +207,570 / −310,507 |
| working notes | `tasks/frontend-live-buildout-2026-08-10.md`, 5,534 lines |
