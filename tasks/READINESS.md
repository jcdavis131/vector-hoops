...
**Nothing here is live.** Everything below is measured at **`95c364d4`** — the sha is the anchor,
...
| | |
|---|---|
| commits ahead of master | 209 at `95c364d4` |
| paths changed | 2,643 (2,547 under `public/`, 42 scripts) |
| insertions / deletions | +210,143 / −310,524 |
| working notes | `tasks/frontend-live-buildout-2026-08-10.md`, 5,856 lines |
