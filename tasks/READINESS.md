...
**Nothing here is live.** Everything below is measured at **`a9e5b978`** — the sha is the anchor,
...
| | |
|---|---|
| commits ahead of master | 158 at `a9e5b978` |
| paths changed | 2,633 (2,547 under `public/`, 33 scripts) |
| insertions / deletions | +203,485 / −310,431 |
| working notes | `tasks/frontend-live-buildout-2026-08-10.md`, 4,540 lines |
