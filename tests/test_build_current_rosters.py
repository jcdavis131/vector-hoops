"""real tests for pipeline.build_current_rosters - wired from coverage gap mapper"""
...
PIPE = ROOT / "pipeline"
MOD_PATH = PIPE / "build_current_rosters.py"
...
spec = importlib.util.spec_from_file_location(f"pipeline.build_current_rosters", str(MOD_PATH))
