"""real tests for pipeline.audit_unicode_names - wired from coverage gap mapper"""
...
PIPE = ROOT / "pipeline"
MOD_PATH = PIPE / "audit_unicode_names.py"
...
spec = importlib.util.spec_from_file_location(f"pipeline.audit_unicode_names", str(MOD_PATH))
...
def test_sample_data_file(tmp_path):
    sample = {"module": "audit_unicode_names", "season": "2023-24", "gp": 70}
