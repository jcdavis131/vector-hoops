...
def main() -> int:
    ...
    print("  (contrast: scripts/check_contrast.py · focus order and skip links:")
    print("   scripts/check_focus.py · phone widths: scripts/check_viewport.py.")
    print("   Whether the reading order makes sense still needs a person.)")
    return 0
