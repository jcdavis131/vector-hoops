...
NEXT_STATS_CONFIGS: list[dict] = [
    _concat_onecycle(
        ...
        nce_loss="hybrid",
        nce_player_weight=0.80,
        nce_arch_weight=0.20,
        w_next_profile=0.05,
    ),
    _concat_onecycle(
...
HYBRID_CONFIGS: list[dict] = [
    ...
    _concat_onecycle(
        "concat-hybrid-010",
        nce_loss="hybrid",
        nce_player_weight=0.90,
        nce_arch_weight=0.10,
    ),
    _concat_onecycle(
        "concat-hybrid-020",
        nce_loss="hybrid",
    ...
    _concat_onecycle(
        "concat-hybrid-030",
        nce_loss="hybrid",
        nce_player_weight=0.70,
        nce_arch_weight=0.30,
    ),
    _concat_onecycle(
        "concat-hybrid-040",
        nce_loss="hybrid",
        nce_player_weight=0.60,
        nce_arch_weight=0.40,
    ),
    _concat_onecycle(
        "concat-hybrid-015-t010",
        nce_loss="hybrid",
        nce_player_weight=0.85,
        nce_arch_weight=0.15,
        nce_temp=0.10,
    ),
    _concat_onecycle(
...
def main() -> None:
    ...
    ap.add_argument(
        ...
        default="refined",
        help=(
            "sweep grid (refined=concat local; architecture=capacity search; "
