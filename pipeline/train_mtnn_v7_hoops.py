...
def torch_train():
    ...
    class Tow(nn.Module):
        def __init__(self,d_in): super().__init__(); self.fc1=nn.Linear(d_in*2,96); se
...
lf.ln1=nn.LayerNorm(96); self.fc2=nn.Linear(96,24); self.ln2=nn.LayerNorm(24); self.skip=nn.Linear(d_in*2,24)
